...
class SelfServiceLoginScreen extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      showPassword: false,
      loginNowScreenActive: false,
      resetYourPasswordScreenActive: false,
  ...
  loginNow = () => {
    const { loginNowScreenActive } = this.state;
    const loginScreenStatus = loginNowScreenActive ? false : true;
    this.setState({ loginNowScreenActive: loginScreenStatus });
  };

  resetYourPassword = () => {
    const { resetYourPasswordScreenActive } = this.state;
    // const { loginNowScreenActive } = this.state;
    // const loginScreenStatus = loginNowScreenActive ? false : true;
    const ResetYourPasswordScreenStatus = resetYourPasswordScreenActive
      ? false
      : true;
    this.setState({
      // loginNowScreenActive: loginScreenStatus,
      resetYourPasswordScreenActive: ResetYourPasswordScreenStatus,
    });
  };
          ...
          <Grid container className={classes.selfServiceLoginScreen}>
            <Grid item className={classes.selfServiceLoginScreenLeftPane}>
              <SelfServiceLoginScreenLeftPane
                ...
                resetYourPassword={this.resetYourPassword}
                ...
                loginNowScreenActive={loginNowScreenActive}
                resetYourPasswordScreenActive={resetYourPasswordScreenActive}
