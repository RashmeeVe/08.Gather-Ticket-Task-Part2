...
const step2 = (props) => {
  const { classes, fname, fnameOfTheDeceased } = props;
...
const SelfServiceLoginScreenLeftPane = (props) => {
  const { stepNumber, selfServiceLoginStep4 } = props;
  ...
  if (stepNumber === 5 && props.className === "slide-back") {
    className = "fade";
  }
